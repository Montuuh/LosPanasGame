...
//	spawnDelay = 0;
//
//	animLeft.PushBack({ 461, 131, 16, 9 });
//	animLeft.PushBack({ 448, 131, 11, 10 });
//	
//	animRight.PushBack({ 416, 131, 16, 9 });
//	animRight.PushBack({ 434, 131, 11, 10 });
//	animLeft.loop = true;
//	animRight.loop = true;
//
//	deathAnim.PushBack({ 497, 137, 13, 7 });
//	deathAnim.loop = false;
//
//	animLeft.speed = 0.10f;
//	animRight.speed = 0.10f;
//	currentAnim = &animLeft;
//
//	collider = app->collisions->AddCollider({ 1, 10, 14, 14 }, Collider::Type::ENEMY_HURTBOX, (Module*)app->entities, Collider::Items::ITEM_NONE);
//}
//
...
//		{
//			SDL_Rect r = { 422,598,4,4 };
//			iPoint pos = app->map->MapToWorld(path.At(i)->x, path.At(i)->y);
//			app->render->DrawTexture(debugTexture, pos.x, pos.y, &r);
//		}
//	}
//
//	if (isDead == false)
